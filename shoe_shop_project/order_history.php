...
<style>
    ...
    .order-card-header strong { color: var(--text-dark); }
    .status {
        padding: 5px 12px;
        border-radius: 20px;
        font-weight: 600;
    ...
    .status.pending, .status.cho-xu-ly { background-color: rgba(255, 193, 7, 0.15); color: #b58500; }
    .status.processing, .status.dang-giao { background-color: rgba(23, 162, 184, 0.15); color: var(--info); }
    .status.shipped, .status.delivered, .status.da-giao-hang, .status.hoan-thanh { background-color: rgba(40, 167, 69, 0.15); color: var(--success); }
    .status.cancelled, .status.da-huy { background-color: rgba(220, 53, 69, 0.1); color: var(--danger); }
    ...
    .order-item-details a { color: var(--text-dark); font-weight: 600; text-decoration: none; }
    .order-item-details a:hover { color: var(--primary); }
    .order-item-details span { color: var(--text-muted); font-size: 0.9em; }
    .order-item-price { font-weight: 600; color: var(--text-body); }
    .order-card-footer {
        display: flex;
        justify-content: space-between;
        align-items: center;
    ...
    .order-card-footer strong { font-size: 1.1rem; color: var(--primary); }
</style>
