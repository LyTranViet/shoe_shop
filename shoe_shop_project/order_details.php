...
<head>
    ...
    <style>
        @media print {
            ...
            .panel { border: none; padding: 10px 0; }
            .summary-row { font-size: 11pt; }
            ...
            <div class="order-items-list">
                ...
                ?>
                    <div class="d-flex align-items-center mb-3 pb-3 border-bottom">
                        <img src="<?php echo $image; ?>" alt="" class="item-image me-3" style="width:70px;height:70px;object-fit:cover;border-radius:6px;">
                        <div class="flex-grow-1">
                            <a href="product.php?id=<?php echo $item['product_id']; ?>" class="text-decoration-none text-dark fw-semibold">
                ...
                <div class="d-flex justify-content-between mb-2">
                    <span>Phí vận chuyển
                        <?php if (!empty($order['shipping_carrier'])): ?>
                            <small class="text-muted">(<?php echo strtoupper(htmlspecialchars($order['shipping_carrier'])); ?>)</small>
                        <?php endif; ?>
                    </span>
                    <span>
